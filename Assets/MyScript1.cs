...
//Debug.Log(incLives); //this is an error because that variable only exists in the function
    ...
    void whatDo(string whoIs, int howMany, string whatIs)
    {
        Debug.Log(whoIs + " " + howMany + " " + whatIs);
    }
    void enemyID(string monA, string monB, string monC)
    {
        Debug.Log(monA + ", " + monB + ", " + monC);
    }
    void randomEnemy()
    {
    }
